...
public class BaseModel extends JsObject {
	...
	public Set<String> getFields() {
		...
		for (String s : getObjectProperties()) {
			props.add(s);
		}
		if (!props.isEmpty()) {
			return props;
	...
	public native String getId() /*-{
		var record = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var id = record.id;
	...
	public native RawModel getRaw()/*-{
		var record = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var val = record.raw;
		var toReturn = @com.ait.toolkit.data.client.RawModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(val);
		return val === undefined || null ? null : toReturn;
	}-*/;
	...
	public static BaseModel create(JavaScriptObject peer) {
		return new BaseModel(peer);
	}
