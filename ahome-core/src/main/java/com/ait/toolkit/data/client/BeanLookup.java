 ...
 * interface that extends <code>BeanMarker</code> and uses annotations. This
 * method does not require the JavaBean to be modified. With the second method,
 * your Java Bean implements the <code>BeanTag</code> interface.
 * 
 * @see BeanMarker
 * @see BeanTag
 */
