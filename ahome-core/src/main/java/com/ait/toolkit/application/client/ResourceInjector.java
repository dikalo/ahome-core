...
public class ResourceInjector {
	...
	public ResourceInjector setJsLoadCallback(JavaScriptLoadCallback cb) {
		this.callBack = cb;
		return this;
	}
	...
	public void loadCss(String url) {
		linkElement = Document.get().createLinkElement();
		linkElement.setRel("stylesheet");
		linkElement.setHref(url);
		attachToHead(linkElement);
	}
