...
public class JsoHelper {
	...
	public static native int getJavaScriptObjectAs3ArraySize(
	...
	public static native JavaScriptObject[] getAttributeAsJavaScriptObjectArray(
		...
		return (arrayJS === undefined) ? null
				: @com.ait.toolkit.core.client.JsoHelper::toArray(Lcom/google/gwt/core/client/JavaScriptObject;)(arrayJS);
	}-*/;
	...
	public static native Date getAttributeAsDate(JavaScriptObject elem,
			String attr) /*-{
                                                                                   var ret = elem[attr];
                                                                                   return (ret === undefined || ret == null) ? null: @com.ait.toolkit.core.client.JsoHelper::toDate(D)(ret.getTime());
                                                                                   }-*/;
	...
	public static native Object getAttributeAsObject(JavaScriptObject elem,
			String attr) /*-{
		var ret = elem[attr];
		return (ret === undefined) ? null : ret;
	}-*/;
	...
	public static native JavaScriptObject createObject() /*-{
		if (typeof ($wnd) != 'undefined' && $wnd.Object) {
	...
	public static JavaScriptObject convertToJavaScriptArray(Object[] array) {
		...
		for (int i = 0; i < array.length; i++) {
			...
			if (val instanceof String) {
				...
				JsoHelper
						.setArrayValue(jsArray, i, ((JsObject) val).getJsObj());
	...
	public static native String[] getProperties(JavaScriptObject jsObj) /*-{
		var props = @com.ait.toolkit.core.client.JsoHelper::createJavaScriptArray()();
		for ( var k in jsObj) {
			props.push(k);
		}
		return @com.ait.toolkit.core.client.JsoHelper::convertToJavaStringArray(Lcom/google/gwt/core/client/JavaScriptObject;)(props);
	}-*/;
